...
public class Boss3Laser2 extends GameObject{
...
;	public static float getxLaser() {
	...
	public Boss3Laser2(float x, float y, ID id, Handler handler, int WidthLaser, int HeightLaser, double theta, float xRotationCenter, float yRotationCenter) {
		super(x, y, id);
